...
#Preparing data to visualize in Tableau
titanicNew<-read.csv("titanicNew.csv")
titanicUpdated<-titanicNew

#Converting categorical variable to continuous variable for clustering
...
#Plot for total within sum of squares
plot(totwss,xlab="Number of Cluster",type="b",
     ylab="Total Within Sum of Square")

#Plot for toatl between sum of squares
